...
libnet_ptag_t init_arp(libnet_t* l, u_int8_t* mac_src, u_int8_t* ip_src,
                       u_int8_t* mac_dst, u_int8_t* ip_dst)
{
...
{
    libnet_t* context;
    char device[] = "eth0"; /* par defaut eth0 est selectionne par libnet */
     ...
     */
    libnet_ptag_t arp_tag = init_arp(context, my_mac->ether_addr_octet,
        (u_int8_t*) &ip_spoofed, mac_target, (u_int8_t*) &ip_target);
    do {
